...
if (!bl[keyTgl]) {
  Bot.sendMessage("❌ Data bulan lalu tanggal " + keyTgl + " belum tersedia.")
...
let spdBL = Number(bl[keyTgl].spd || 0)

let stdBL = Number(bl[keyTgl].std || 0)

let apcBL = Number(bl[keyTgl].apc || 0)
